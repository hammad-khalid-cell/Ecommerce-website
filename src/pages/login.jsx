      ...
      <div className="flex flex-col  md:flex-row items-center justify-between gap-16 ">
        ...
        <div className="w-1/3 md:w-2/5 bg-white p-8 rounded-lg ">
          ...
          <form className="space-y-4">
            <input type="text" placeholder="Name" className="w-full p-3 border-b border-gray-300  focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <input type="email" placeholder="Email or Phone Number" className="w-full p-3 border-b border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <input type="password" placeholder="Password" className="w-full p-3 border-b border-gray-300  focus:outline-none focus:ring-2 focus:ring-blue-500" />
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-gray-500 mt-8">
              Already have account? <a href="#" className="hover:text-red-500 font-semibold hover:underline ease-in-out ">Log in</a>
            </p>
          </div>
        </div>
      </div>
